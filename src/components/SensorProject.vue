<template>
	<b-card-group deck style="margin: 10%">
		<br />
		<b-card title="Ultima Temperatura" bg-variant="primary" text-variant="white">
			<b-card-text>
				<h4>{{ lastTemperature }}°</h4>
			</b-card-text>
			<br />
		...
		<br />
		<b-card title="Ultima Umidade do Solo" bg-variant="primary" text-variant="white">
			<b-card-text>
